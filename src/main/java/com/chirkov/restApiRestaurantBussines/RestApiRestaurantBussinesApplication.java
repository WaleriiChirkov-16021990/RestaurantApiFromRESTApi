...
//
//    @Bean
//    CommandLineRunner runner(DiscountService discountService, Faker faker) {
//        return args -> {
...
//    @Bean
//    CommandLineRunner runner(UnitsOfMeasurementService ofMeasurementService, Faker faker) {
//        return args -> {
...
//
//    @Bean
//    CommandLineRunner runner(StateFromTablesService stateFromTablesService) {
//        return args -> {
...
//
//    @Bean
//    CommandLineRunner runner(DishesService service) {
//        return args -> {
